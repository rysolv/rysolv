...
const questions = [
  ...
  // description
  {
    ...
    created_date: new Date(),
    priority: 4,
    question_key: 'position_description',
    question_text: 'Are you a US citizen?',
    required: false,
    response_limit: 1,
    subtext: null,
  ...
  // experience
  {
    ...
    created_date: new Date(),
    priority: 6,
    question_key: 'position_experience',
    question_text: 'Are you a US citizen?',
    required: true,
    response_limit: 1,
    subtext: null,
  ...
  // location
  {
    ...
    created_date: new Date(),
    priority: 3,
    question_key: 'position_location',
    question_text: 'Are you a US citizen?',
    required: true,
    response_limit: 1,
    subtext: null,
