export const CLEAR_ALERTS = 'app/Companies/CLEAR_ALERTS';

export const CLEAR_FORM = 'app/Companies/CLEAR_FORM';

export const DELETE_COMPANY = 'app/Companies/DELETE_COMPANY';
export const DELETE_COMPANY_FAILURE = 'app/Companies/DELETE_COMPANY_FAILURE';
export const DELETE_COMPANY_SUCCESS = 'app/Companies/DELETE_COMPANY_SUCCESS';

export const FETCH_COMPANIES = 'app/Companies/FETCH_COMPANIES';
