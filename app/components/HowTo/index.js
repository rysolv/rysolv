          ...
          <HeaderDescription>
            ...
            <StepDescription>
              ...
              <ul>
                ...
                <li>
                  Add a bounty to your issue. Once an issue is on Rysolv, anyone
                  can add to the bounty.
                </li>
                <li>
                  <b>Submit a solution!</b> Just upload a pull request that
                  resolves the issue, and Rysolv will keep track of when it gets
                  merged in.
                </li>
                <li>
            ...
            <StepDescription>
              ...
              <ul>
                <li>
                  ...
                  account to Rysolv. You can do this by signing up with Github,
                  or on your{' '}
      ...
      <StepContainer>
        <StepWrapper>
          <StepContentWrapper>
            <StepName>Step 1</StepName>
            <StepDescription>
              When you have a solution ready, create a pull request in the repo.
              <br />
              <br />
        ...
        <StepWrapper>
          <StepContentWrapper>
            <StepName>Step 2</StepName>
            <StepDescription>
              Once you submit a Pull Request, Rysolv will monitor the issue for
              ...
              PR has been accepted, and you&apos;ll see your new balance on your{' '}
              <StyledInternalLink to="/settings/account">
                settings page
              </StyledInternalLink>
              .
      ...
      <StepContainer>
        <StepWrapper>
          <StepContentWrapper>
            ...
            <StepDescription>
              When a pull request has been merged in and the corresponding issue
              closed, you will be notified of a pending bounty. To accept this
              bounty, head to your
              ...
              <ul>
                ...
                <ul>
                  <li>
                    ...
                    Open Collective, or Paypal. The payments will be aggregated
                    on Rysolv and distributed at the end of each month.
                  </li>
                </ul>
                <li>
        ...
        <StepWrapper>
          <StepContentWrapper>
            ...
            <StepDescription>
              ...
              <ul>
                <li>
                  There will be a <b>3% + $0.30 standard transaction fee</b> on
                  withdrawals to cover payment processing.
                </li>
              </ul>
            </StepDescription>
          </StepContentWrapper>
          ...
          <StepContentWrapper>
            ...
            <StepDescription>
              ...
              <ul>
                ...
                <li>
                  You will receive an email notification when your withdrawal is
                  complete.
                </li>
              </ul>
            </StepDescription>
