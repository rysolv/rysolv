            ...
            <OverviewActivityContainer>
              ...
              <IssueDetailOverview>
                ...
                <IssueDetailBody>
                  ...
                  dropped. My CPU nor GPU is significantly going up in usage. To
                  confirm OBS ignores the 709 part, I selected i444 with 709 and
                  the other PC confirmed that its somehow a 709 matrix over a
                  601 source. My Decklink card doesnt support keying, only 1 SDI
                  output, but I was recommended by der_rod on Twitter to force
                  keyer to 3 in the appdata config. This gave me a very clean
                  4:4:4 output on 709, but it dropped so many frames that its
                  not usable. I wouldnt be able to use it anyway since my
                  Decklink card in the stream PC doesnt support 4:4:4 above
                  1080p30.
                </IssueDetailBody>
              </IssueDetailOverview>
            </OverviewActivityContainer>
            ...
            <OverviewActivityContainer>
              ...
              <IssueDetailOverview>
                ...
                <IssueDetailBody>
                  ...
                  to set color space for Decklink output, since OBS-Studio 24.03
